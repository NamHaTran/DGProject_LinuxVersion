...
Bản backup 21/05/2021 - Tách sang nhánh Classical NSF:
- Bản code này remove phần mass diffusion, chỉ giữ lại phần giải pt Classical NSF.
- Đã apply việc remove mu ở biến phụ trước khi correct biến gradient theo điều kiện biên.
- Là gốc cơ bản để phát triển thêm các mô hình NSF mở rộng khác.