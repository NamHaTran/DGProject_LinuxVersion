...
To convert unv mesh format to DG2D readable format, do following task step by step:
    ...
    void showCaseInformations()
    {
        ...
        if (flowProperties::massDiffusion)
        {
            ...
            if (flowProperties::mass_C==0)
            {
                std::cout<<"       + Kinematic energy due to mass diffusion is NOT INCLUDED in Totol Energy.\n";
            }
            else if (flowProperties::mass_C==1)
            {
                std::cout<<"       + Kinematic energy due to mass diffusion is INCLUDED in Totol Energy.\n";
            }
